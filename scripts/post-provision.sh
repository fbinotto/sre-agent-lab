...
# Build the repo name from username (defaults to fbinotto if not set)
export GITHUB_REPO="${GITHUB_USER:+${GITHUB_USER}/grubify}"
GITHUB_REPO="${GITHUB_REPO:-fbinotto/grubify}"
export GITHUB_REPO
...
GRUBIFY_REPO="https://github.com/fbinotto/grubify.git"
...
$PYTHON -c "
import json, os
repo = os.environ.get('GITHUB_REPO', 'fbinotto/grubify')
